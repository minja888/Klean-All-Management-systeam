...
export const dictionary = {
  ...
  "accounting.tabPayments": { en: "Payments & Debts", sw: "Malipo & Madeni" },
  "accounting.tabCapital": { en: "Capital", sw: "Mtaji" },
  "accounting.tabLedger": { en: "Ledger book", sw: "Daftari la Fedha" },

  // Capital
  "capital.summaryCapital": { en: "Owner's capital", sw: "Mtaji wa mmiliki" },
  "capital.summaryLoans": { en: "Loans outstanding", sw: "Mikopo inayodaiwa" },
  "capital.summaryIn": { en: "Total invested", sw: "Jumla iliyowekezwa" },
  "capital.summaryDrawings": { en: "Drawings (taken out)", sw: "Zilizochukuliwa" },
  "capital.new": { en: "New entry", sw: "Ingizo jipya" },
  "capital.type": { en: "Type", sw: "Aina" },
  "capital.CAPITAL": { en: "Capital in (investment)", sw: "Mtaji umeingia (uwekezaji)" },
  "capital.LOAN": { en: "Loan received (debt)", sw: "Mkopo umepokelewa (deni)" },
  "capital.LOAN_REPAYMENT": { en: "Loan repayment", sw: "Kulipa mkopo" },
  "capital.DRAWING": { en: "Drawing (owner takes out)", sw: "Mmiliki amechukua pesa" },
  "capital.hint": { en: "Money entering the business from outside must be recorded here — clearly marked as new capital or as a loan (debt).", sw: "Pesa inayoingia biasharani kutoka nje lazima irekodiwe hapa — ionekane wazi kama mtaji mpya au mkopo (deni)." },

  // Ledger
  "ledger.date": { en: "Date", sw: "Tarehe" },
  "ledger.description": { en: "Description", sw: "Maelezo" },
  "ledger.type": { en: "Type", sw: "Aina" },
  "ledger.in": { en: "Money in", sw: "Imeingia" },
  "ledger.out": { en: "Money out", sw: "Imetoka" },
  "ledger.balance": { en: "Balance", sw: "Salio" },
  "ledger.opening": { en: "Opening balance", sw: "Salio la kuanzia" },
  "ledger.closing": { en: "Cash balance", sw: "Salio la fedha" },
  "ledger.totalIn": { en: "Total in", sw: "Jumla iliyoingia" },
  "ledger.totalOut": { en: "Total out", sw: "Jumla iliyotoka" },
  "ledger.SALE": { en: "Sale", sw: "Mauzo" },
  "ledger.PAYMENT_IN": { en: "Customer payment", sw: "Malipo ya mteja" },
  "ledger.PAYMENT_OUT": { en: "Supplier payment", sw: "Malipo kwa msambazaji" },
  "ledger.PURCHASE": { en: "Purchase", sw: "Manunuzi" },
  "ledger.EXPENSE": { en: "Expense", sw: "Matumizi" },
  "ledger.PAYROLL": { en: "Payroll", sw: "Mishahara" },
  "ledger.CAPITAL": { en: "Capital in", sw: "Mtaji umeingia" },
  "ledger.LOAN": { en: "Loan in", sw: "Mkopo umeingia" },
  "ledger.LOAN_REPAYMENT": { en: "Loan repayment", sw: "Kulipa mkopo" },
  "ledger.DRAWING": { en: "Drawing", sw: "Imechukuliwa na mmiliki" },

  // Period quick filters
  "period.today": { en: "Today", sw: "Leo" },
  "period.thisWeek": { en: "This week", sw: "Wiki hii" },
